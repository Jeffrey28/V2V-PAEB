function [range,velocity,theta] = extract(radar_data,TISdet)
%#codegen
...
for i=1:Max_Num_Detected_objects
    range(i) = radar_data(Max_Num_Detected_objects*1 + i);
    velocity(i) = radar_data(Max_Num_Detected_objects*2 + i);
    theta(i) = radar_data(Max_Num_Detected_objects*6 + i);
